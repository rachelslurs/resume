...
import { themePropDefs, getMatchingGrayColor, useThemeContext, Theme } from '@radix-ui/themes';

import '@radix-ui/themes/styles.css';

import type { ComponentPropsWithout, RemovedProps } from './helpers';
import type { GetPropDefTypes } from './props';
import { setColor, setTheme } from 'src/app/actions.server';
                    ...
                    >
                      <input
                        ...
                        onChange={async(event) => {
                            await setColor(event.target.value)
